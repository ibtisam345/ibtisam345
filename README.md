...
<!-- ========================================================
  HEADER — Update the typing lines below as your identity evolves.
...
<!-- ========================================================
  ABOUT ME — Update the Python class fields as you grow.
  - Add new languages/tools to the lists
  - Update "currently" when your focus shifts
...
class Ibtisam_Adnan:
    ...
    interests  = ["Problem Solving", "Algorithms", "Software Development"]
    currently  = "Strengthening fundamentals & building real projects 🚀"
    motto      = "Learn. Build. Break. Debug. Understand. Repeat."
```

I enjoy learning programming by **actually building things**, solving problems, and experimenting with ideas. I believe good programming is less about memorizing syntax and more about learning how to think clearly — especially when the computer stubbornly refuses to cooperate. 😄

---

<!-- ========================================================
  TECH STACK — To add a new skill icon, go to:
  https://skillicons.dev
  And add the icon name to the i= list (comma-separated).
...
<img src="https://skillicons.dev/icons?i=c,python,html,git,github,vscode&perline=6" alt="Tech Stack" />
...
<!-- ========================================================
  CURRENTLY LEARNING — UPDATE THIS REGULARLY.
  This is the most important section to keep fresh.
  As you finish a topic, move it to a "Completed" section
...
```text
C Programming
├── Problem solving with loops & conditions
...
<!-- ========================================================
  WHAT I'M WORKING TOWARD — Update this when your goals shift.
...
<img src="https://raw.githubusercontent.com/ibtisam345/ibtisam345/output/github-contribution-grid-snake-dark.svg" alt="GitHub Contribution Snake" />
...
<!-- ========================================================
  CONNECT — Add social links here as you create profiles.
...
<img src="https://capsule-render.vercel.app/api?type=waving&height=120&section=footer&color=0:0d1117,50:00d4ff,100:0d1117&animation=fadeIn" />
